...
@Repository
public interface WooshopFreightTemplateAssignMapper extends CoreMapper<WooshopFreightTemplateAssign> {

    @Select("DELETE FROM wooshop_freight_template_assign WHERE template_id=#{template_id}")
