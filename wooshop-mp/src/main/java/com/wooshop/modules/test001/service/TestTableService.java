...
package com.wooshop.modules.test001.service;
...
public interface TestTableService  extends BaseService<TestTable>{
    ...
    */
    PageResult<TestTableDto>  queryAll(TestTableQueryCriteria criteria, Pageable pageable);
    ...
    */
    List<TestTable> queryAll(TestTableQueryCriteria criteria);
    ...
    * @throws IOException /
    */
    void download(List<TestTableDto> all, HttpServletResponse response) throws IOException;
}
