...
@Repository
public interface WooshopStoreGoodsSukMapper extends CoreMapper<WooshopStoreGoodsSuk> {



     @Select("DELETE FROM wooshop_store_goods_suk WHERE goods_id=#{goods_id} and activity_type=#{activity_type}")
