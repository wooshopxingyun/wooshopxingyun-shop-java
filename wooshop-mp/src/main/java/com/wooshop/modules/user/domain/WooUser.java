package com.wooshop.modules.user.domain;
...
public class WooUser extends CommonEntity<WooUser> implements Serializable {
    ...
    @ApiModelProperty(value = "用户注册客户端类型 h5 小程序 公众号")
